...
[![build status](https://img.shields.io/travis/dramaorg/voluptate-exercitationem-qui/master.svg?style=flat-square)](https://travis-ci.org/dramaorg/voluptate-exercitationem-qui)
[![npm version](https://img.shields.io/npm/v/@dramaorg/voluptate-exercitationem-qui.svg?style=flat-square)](https://www.npmjs.com/package/@dramaorg/voluptate-exercitationem-qui)
...
```sh
npm install @dramaorg/voluptate-exercitationem-qui @stripe/stripe-js
```
...
import {
  ...
  useStripe,
  useElements,
} from '@dramaorg/voluptate-exercitationem-qui';
